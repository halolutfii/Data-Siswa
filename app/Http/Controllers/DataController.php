...
class DataController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Alert::success('Berhasil', 'Berhasil Menambahkan Data Siswa Alumni');
    ...
    public function update(Request $request, $id)
    {
        ...
        Alert::success('Berhasil', 'Berhasil Update Data Siswa Alumni');
        return redirect ('/data');
    }
    ...
    public function destroy($id)
    {
        ...
        Alert::success('Berhasil', 'Berhasil Menghapus Data Siswa Alumni');
        return redirect('/data');
    }
}
