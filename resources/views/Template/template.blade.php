        ...
        <head>
            ...
            <title>DATA ALUMNI | SMK LETRIS INDONESIA 2</title>

            <meta name="description" content="" />

            <!-- Favicon -->
            <link rel="icon" type="image/x-icon" href="{{asset('/template/assets/img/favicon/logoletris.png')}}" />
            ...
            <body>
                ...
                <div class="layout-wrapper layout-content-navbar">
                    ...
                    <footer class="content-footer footer bg-footer-theme">
                        ...
                        , made with ❤️ by Mahasiswa KP Universitas Pamulang.
                    </div>
                </div>
            </footer>
            <!-- / Footer -->
